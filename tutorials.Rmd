...
To this end, this page provides a structured directory of tutorials I've written that are suitable for beginner-level programmers. It is *not* a full directory of all tutorials I've ever written. To see a more comprehensive list, [check out my blog entries tagged with "tutorials"](./blog.html#category:tutorials).
...
- [cog-comp-modeling](https://github.com/psychNerdJae/cog-comp-modeling)
  - Learn how to use computational models to address questions in cognitive and psychological science
