...
date: "2021-07-12"
categories: [tutorials, coding, rstats]
image: "image.png"
---
...
![](r-console.png){fig-alt="R console (left) compared against a macOS terminal (right)"}
...
![](rstudio-annotated.png){fig-alt="Annotated image of RStudio window, entirely redundant with the in-line text descriptions."}
