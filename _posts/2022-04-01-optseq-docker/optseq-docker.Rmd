---
title: "Using optseq2 on modern computers"
date: April 1, 2022
output:
...
This particular post is a "mirror" copy of the readme found in the GitHub repository [psychNerdJae/optseq_docker](https://github.com/psychNerdJae/optseq_docker), which contains the Dockerfile and Linux binary needed to run this example.
