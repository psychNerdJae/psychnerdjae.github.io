...
```{r echo=FALSE, out.width = "55%", fig.align='center', fig.alt="I got my research training at Stanford (BA) and Brown (PhD)."}
knitr::include_graphics("images/education_employment.png")
```

# About me

```{r echo=FALSE, out.width = "70%", fig.align='center', fig.alt="I've lived in South Korea, North Carolina, Tennessee, California, and Rhode Island."}
